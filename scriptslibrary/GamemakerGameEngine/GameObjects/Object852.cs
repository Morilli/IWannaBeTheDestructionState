...
public sealed class Object852 : GameObject
{
    private class Clock0 : Cock
    {
        public Clock0(Object852 parent) : base(() =>
        {
    ...
    {
        public Clock1(Object852 parent) : base(() =>
        {
            for (int i = 0; i < 2; i++)
            {
    ...
    public Object852(GameEngine engine, double initialX, double initialY) : base(engine, initialX, initialY)
    {
        Clocks = new Cock[]
        {
            new Clock0(this),
